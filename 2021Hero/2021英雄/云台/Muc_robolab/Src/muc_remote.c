...
void CheckKeyBoardStatus( void )
{
	...
	CC_Condition.Key_X = (KeyBoardSta)(!( g_RcRawData.key_code&Key_X_FLAG));//180度
	CC_Condition.Key_C = (KeyBoardSta)(!( g_RcRawData.key_code&Key_C_FLAG));
	CC_Condition.Key_V = (KeyBoardSta)(!( g_RcRawData.key_code&Key_V_FLAG));//视觉
