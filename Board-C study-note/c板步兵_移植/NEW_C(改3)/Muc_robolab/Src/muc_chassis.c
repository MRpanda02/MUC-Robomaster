...
void CMControlForChassisLoopTask(void)
{
	...
	FrontBackTemp = (int)CMFrontBackSpeed*cosData;
	LeftRightTemp = (int)(CMFrontBackSpeed*sinData);					//原来有个-,看起来没什么用

	LeftRightTemp += (int)CMLeftRightSpeed*cosData;
	FrontBackTemp += (int)CMLeftRightSpeed*sinData;
	
//	if(CC_Condition.S1Sta == SwitchAction_3TO1)
//		Sta_To_Circle = 1;
//	
//	if(CC_Condition.S1Sta == SwitchAction_1TO3)
//		Sta_To_Circle = 0;
	//Sta_To_Fllow = 0;
	// 获取遥控器中发来的数据  （解析到四个电机，使四个电机获取到应该有的转速）
//	if(Sta_To_Circle == 0){
	CM1_target_speed = (-LeftRightTemp - FrontBackTemp) * KP_Remote * SuperCap_cjh + (int)(CM_rotate_pid.output*KP_Rotate*Sta_To_Fllow)+(int)1000*Sta_To_Circle;		//+
	CM2_target_speed = (-LeftRightTemp + FrontBackTemp) * KP_Remote * SuperCap_cjh + (int)(CM_rotate_pid.output*KP_Rotate*Sta_To_Fllow)+(int)1000*Sta_To_Circle;		//+
	CM3_target_speed = (LeftRightTemp  + FrontBackTemp) * KP_Remote * SuperCap_cjh + (int)(CM_rotate_pid.output*KP_Rotate*Sta_To_Fllow)+(int)1000*Sta_To_Circle;		//-
	CM4_target_speed = (LeftRightTemp  - FrontBackTemp) * KP_Remote * SuperCap_cjh + (int)(CM_rotate_pid.output*KP_Rotate*Sta_To_Fllow)+(int)1000*Sta_To_Circle;		//-
//	}
	
//	if(Sta_To_Circle == 1){
//	CM1_target_speed = (-LeftRightTemp - FrontBackTemp) * KP_Remote * SuperCap_cjh +(int)1000*Sta_To_Circle;		//+
//	CM2_target_speed = (-LeftRightTemp + FrontBackTemp) * KP_Remote * SuperCap_cjh +(int)1000*Sta_To_Circle;		//+
//	CM3_target_speed = (LeftRightTemp  + FrontBackTemp) * KP_Remote * SuperCap_cjh -(int)1000*Sta_To_Circle;		//-
//	CM4_target_speed = (LeftRightTemp  - FrontBackTemp) * KP_Remote * SuperCap_cjh -(int)1000*Sta_To_Circle;		//-	
//	}
